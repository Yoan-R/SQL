...
-------------------------------------------- -- CHAP 5 -- ---------------------------------------------------------
-- AFFICHER LES NOMS, PRENOM ET SERVICE DES EMPLOYES QUI ONT ETAIENT EMBAUCHE ENTRE 2010-01-01 ET 2021-03-16 -------
-------------------------------------------------------------------------------------------------------------------
-- USE BETWEEN

SELECT nom, prenom, service FROM employes WHERE date_embauche BETWEEN '2010-01-01' AND '2021-03-16';
...
SELECT nom, prenom, service FROM employes WHERE date_embauche BETWEEN '2015-01-01' AND CURRENT_DATE;
...
SELECT SUM(salaire *12) AS masse_salarial FROM employes;
...
SELECT COUNT(sexe) AS 'nb_femme' FROM employes WHERE sexe = 'f';
SELECT COUNT(sexe) AS 'nb_homme' FROM employes WHERE sexe = 'm';
...
SELECT MAX(salaire) AS 'salaire_le_plus_eleve' FROM employes;
...
SELECT salaire, nom, prenom FROM employes WHERE salaire = 1390;
...
SELECT service, COUNT(*) AS nb_employes FROM employes GROUP BY service HAVING COUNT(service)>2;
-----------------------------------------------------------------------------------------------------------------
-------------------------------------------- -- RESPONSE  -- ----------------------------------------------------
-----------------------------------------------------------------------------------------------------------------
...
--------------------------------------------------------------------------------------------------------------------
-- USE CURDATE()
SELECT nom , prenom , service FROM employes WHERE date_embauche BETWEEN '2015-01-01' AND CURDATE();
...
-- USE AS (ALIAS)
-- WHERE
SELECT COUNT(sexe) AS 'nb_femmes' FROM employes WHERE sexe != 'm';
SELECT COUNT(sexe) AS 'nb_hommes' FROM employes WHERE sexe != 'f';
----------------------------------------------------------------------------------------------------
-------------------------------------------- -- RESPONSE  -- ---------------------------------------
----------------------------------------------------------------------------------------------------
+----------+
